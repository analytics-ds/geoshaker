    ...
    return [
      {
        ...
        priority: "BLOQUANT",
        status: "fail",
        detail: `Aucun vrai /llms.txt détecté (${reason}). Le llms.txt est le manifeste GEO à adopter, il oriente les LLM vers vos pages stratégiques.`,
        advice:
          "Créez un fichier /llms.txt en text/plain à la racine de votre domaine. Structure en markdown : titre H1, blockquote d’intro, sections par thème, URLs absolues en listes à puces.",
      },
      {
        id: "5.2",
        step: 5,
        ...
        priority: "MOYENNE",
        status: "fail",
        detail: "Pas de fichier à évaluer, donc rien d’exploitable pour les LLM.",
        advice: "Une fois le fichier créé, structurez-le en markdown avec au moins 2 titres et 3 URLs absolues.",
      },
      {
        id: "5.3",
        step: 5,
        ...
        priority: "MOYENNE",
        status: "fail",
        detail: "Pas de fichier, donc zéro URL listée pour les LLM.",
        advice: "Listez au minimum 3 URLs stratégiques dans le llms.txt (page d’accueil, pages piliers, articles de référence).",
      },
    ];
  }
